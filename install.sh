#!/bin/bash
#
# XUI.ONE One-Click Installer
# Maintained by Shahid Malla — https://shahidmalla.com
# Repo: https://github.com/shahidmallaofficial/xui-installer
#

REPO="shahidmallaofficial/xui-installer"
BRANCH="main"
RELEASE_TAG="v1.5.12"
XUI_ZIP="XUI_1.5.12.zip"

echo -e "\n================================================================"
echo -e " XUI.ONE Installer  |  by Shahid Malla  |  shahidmalla.com"
echo -e "================================================================\n"
